...
@section('pageTitle', 'Подать бесплатный аукцион')
@section('contentTitle', 'Подать бесплатный аукцион')

@section('breadcrumb')
    <li><a href="#">Home</a></li>
    <li class="active">Аукцион</li>
@stop
...
@section('userContent')
    <div class="row">
        <div class="col-md-offset-2 col-md-8" id="product">
            ...
            <div class="form-group">
                ...
                <div id="type_id">
                    {!! Helpers::select($auctionTypes, old('type_id'), 'Выберите тип аукциона', ["class" => "form-control", "form" => "publish", "name" => "type_id"]) !!}
                </div>
            </div>
            <div class="form-group">
    ...
    <form id="publish" data-src="{{route('user::auctionStore')}}"></form>
@stop